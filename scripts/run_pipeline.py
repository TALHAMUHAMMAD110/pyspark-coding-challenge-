...
if __name__ == '__main__':
    # This section is for local testing or demonstration purposes.
    spark = SparkSession.builder.appName("SparkCodingChallenge").getOrCreate()
    
    # Create sample dataframes based on the schemas
    impressions_data = [("2023-01-01", "id1", 1, [(101, True), (102, False)]),
                        ("2023-01-01", "id2", 2, [(201, True), (202, False)])]
    
    clicks_data = [
        ("2022-12-30", 1, 103, "2022-12-30 10:00:00"),
        ("2022-12-31", 1, 104, "2022-12-31 11:00:00")
    ]
